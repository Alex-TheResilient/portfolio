...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      'Responsive portfolio website showcasing modern web development skills. Features glassmorphism design aesthetics, dynamic theme switching, interactive project filtering, and smooth animations.',
    ...
    features: [
      ...
      'Interactive technology stack filtering',
    ...
    demoUrl: 'https://portfolio-khaki-seven-93.vercel.app/',
    images: [
      '/images/portfolio/hero-section.avif',
      '/images/portfolio/tech-filter.avif',
      '/images/portfolio/projects-grid.avif',
      '/images/portfolio/dark-mode.avif',
      '/images/portfolio/projects-grid2.avif',
    ],
  },
];
