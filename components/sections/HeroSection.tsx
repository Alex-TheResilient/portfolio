...
export default function HeroSection() {
  return (
    <section className="min-h-[calc(100vh-80px)] p-8 flex items-center justify-center">
      <div className="flex gap-12 max-w-6xl mx-auto w-full px-4 lg:gap-20">
        {/* Card */}
        ...
        <div className="flex-1 space-y-8">
          <h2 className="text-7xl font-display-pacifico text-center">Hello</h2>
